...
export const REGION_BOUNDS: Record<string, { minLat: number; maxLat: number; minLon: number; maxLon: number }> = {
  ...
  peru: { minLat: -18.5, maxLat: 0, minLon: -81.5, maxLon: -68 },
  chile: { minLat: -56, maxLat: -17.5, minLon: -76, maxLon: -66 },
  argentina: { minLat: -55, maxLat: -21.5, minLon: -73.5, maxLon: -53.5 },
  ecuador: { minLat: -5, maxLat: 2, minLon: -81.5, maxLon: -75 },
